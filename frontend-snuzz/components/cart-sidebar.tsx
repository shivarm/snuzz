            ...
            {cartItems.length === 0 ? (
              ...
              <div className="space-y-3 md:space-y-4">
                {cartItems.map((item, index) => (
                  ...
                  >
                    <div className="w-12 md:w-16 h-12 md:h-16 bg-gradient-to-br from-[#8cedf8] to-[#3AF0F7]/30 rounded-lg flex items-center justify-center shadow-sm hover:shadow-md transition-shadow duration-200">
                      <div className="text-gray-800 font-bold text-xs">{item.image}</div>
                    </div>
